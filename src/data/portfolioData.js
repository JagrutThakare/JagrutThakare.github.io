export const portfolioData = {
    ...
    experience: [
        ...
        },
        {
            ...
            location: "India",
            description: "Implementing Simple Machine Learning models to Predict Percentage of Student based on No. of study hours, From the Given 'Iris' data set, predict the optimum number of clusters and represent it visually"
        }
    ],
    education: [
        {
